...
(function() {
  ...
  $.fn.fancySelect = function(opts) {
    ...
    return this.each(function() {
      ...
      // Disabled below handler because VNC console requires focus
      ...
      sel.on('change', function(e) {
        $('#noVNC_canvas').focus(); // Shift focus to VNC console
      ...
      options.on('click', 'li', function(e) {
        ...
        clicked = true;
        return sel.val($(this).data('value')).trigger('change').trigger('blur');
      });
