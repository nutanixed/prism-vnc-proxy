...
function onRfbEvent(evt) {
    if (conf.onKeyPress) {
        ...
        // To accommodate changes in scancode mapping in keyboard.js for ESX.
        conf.onKeyPress(evt.keysym, evt.scancode, evt.type === 'keydown');
        // End Nutanix change
    }
}

// create the keyboard handler
var k = KeyEventDecoder(null, onRfbEvent);
...
that.grab = function() {
    ...
    // ENG-88631 (Incorporate https://github.com/novnc/noVNC/commit/4b20f2364c3924e89ccedf7eda56af322e5e9e1e
